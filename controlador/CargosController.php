...
class CargosController {
    ...
    public function eliminar($id) {
        ...
        echo "<script> alert ('Completado: Cargos Eliminado correctamente.')</script>";
        echo '<script language="javascript">window.location="CargosIndex.php"</script>';
        exit;
        // Puedes agregar lógica adicional después de eliminar el Cargos si es necesario
    }
