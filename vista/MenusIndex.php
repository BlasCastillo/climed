...
?>
    <tr>
        ...
        <td>
            <?php if($_SESSION['valor_rol'] == '1'): ?>
                <a class="btn btn-outline-warning" href="CargosEditar.php?id=<?php echo $menu['id']; ?>"><i class="fa fa-pencil-alt"></i></a>
                <a class="btn btn-outline-danger" href="CargosEliminar.php?id=<?php echo $menu['id']; ?>"><i class="fa fa-trash-alt"></i></a>
            <?php endif; ?>
        </td>
    </tr>
<?php 
    ...
    echo "<tr><td colspan='5'>" . $menus . "</td></tr>";
}
?>
