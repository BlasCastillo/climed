    ...
    <div class="container-fluid pt-4 px-4">
        <div class="bg-light rounded h-100 p-4">
            ...
            <div class="table-responsive">
                ...
                <br><a class="btn btn-primary" href="PatologiasCrear.php">Nueva Patología</a>
                <?php endif; ?>

                <?php if($_SESSION['valor_rol'] == '1'): ?>
                                <a  class="btn btn-outline-primary m-2" href="Reporte_Patologias.php">Imprimir lista <i class="fa-solid fa-file-pdf"></i></a>
                ...
                <table id="tabla" class="table">
                        ...
                        <tr>
                            ...
                            ?></td>
                            <td><?php if ($Patologia['valor'] == 1) {
                                    echo  'Enfermedades infecciosas';
                                } else{
                                    if ($Patologia['valor'] ==2 ) {
                                        echo 'Enfermedades no infecciosas';
                                    } else{
                                        ...
                                        { if ($Patologia['valor'] == 4) {
                                         echo 'Enfermedades congénitas';
                                }else{ if ($Patologia['valor'] == 5) {
                                         echo 'Trastornos mentales';}
                                     }} }}}
                            ...
                            <?php if($_SESSION['valor_rol'] == '1'):?>
                                ...
                                <a class="btn btn-outline-danger m-2" href="PatologiasEliminar.php?id=<?php echo $Patologia['id']; ?>"><i class="fa fa-trash-alt"></i></a>
                            <?php endif; ?>
