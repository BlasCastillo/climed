        ...
        <!-- Navbar End -->
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row vh-100 bg-light rounded align-items-center justify-content-center mx-0">
                    ...
                    <img
                        src="dist/plantilla/img/illustrations/man-with-laptop-light.png"
                        alt="man-with-laptop-light"
                        width="500"
                        class="img-fluid"
                    ...
                    />
                        ...
                        <h1 class="mb-4">Pagina en Mantenimiento</h1>
                        <p class="mb-4">¡Lo sentimos, la página que ha buscado no se encuentra activa en estos momentos!
